...
public class BrowserPanelHandle extends NodeHandle<Node> {
    ...
    public BrowserPanelHandle(Node browserPanelNode) {
        ...
        new GuiRobot().interact(() -> engine.getLoadWorker().stateProperty()
    ...
    /**
     * Returns true if the current {@code URL} is different from the value remembered by the most
     * recent {@code rememberUrl()} call.
     */
    ...
    /**
     * Returns true if the browser is done loading a page, or if this browser has yet to load any
     * page.
     */
