...
public class AddCommandSystemTest extends TaskCollectionSystemTest {
    ...
    public void add() {
        ...
        command = AddCommand.COMMAND_WORD + NAME_DESC_BOB + PHONE_DESC_AMY + PRIORITY_DESC_AMY + EMAIL_DESC_AMY
            + ADDRESS_DESC_AMY
            + TAG_DESC_FRIEND;
        assertCommandSuccess(command, toAdd);
        ...
        toAdd = BOB;
        command = AddCommand.COMMAND_WORD + TAG_DESC_FRIEND + PHONE_DESC_BOB + PRIORITY_DESC_BOB + ADDRESS_DESC_BOB
            + NAME_DESC_BOB
        ...
        command = AddCommand.COMMAND_WORD + PHONE_DESC_AMY + PRIORITY_DESC_AMY + EMAIL_DESC_AMY + ADDRESS_DESC_AMY;
        ...
        command = AddCommand.COMMAND_WORD + NAME_DESC_AMY + PHONE_DESC_AMY + PRIORITY_DESC_AMY + INVALID_EMAIL_DESC
            + ADDRESS_DESC_AMY;
