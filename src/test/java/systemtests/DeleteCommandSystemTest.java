...
public class DeleteCommandSystemTest extends TaskCollectionSystemTest {
    ...
    /**
     * Deletes the task at {@code toDelete} by creating a default {@code DeleteCommand} using {@code
     * toDelete} and performs the same verification as {@code assertCommandSuccess(String, Model,
     * String)}.
     *
    ...
    /**
     * Performs the same verification as {@code assertCommandSuccess(String, Model, String)} except
