...
public abstract class TaskCollectionSystemTest {
    ...
    protected void showAllPersons() {
        ...
        assertEquals(getModel().getAddressBook().getTaskList().size(),
    ...
    protected void showPersonsWithName(String keyword) {
        ...
        assertTrue(getModel().getFilteredPersonList().size() < getModel().getAddressBook()
            .getTaskList().size());
    }
    ...
    protected void assertApplicationDisplaysExpected(String expectedCommandInput,
        ...
        assertEquals(new TaskCollection(expectedModel.getAddressBook()),
            testApp.readStorageAddressBook());
        assertListMatching(getPersonListPanel(), expectedModel.getFilteredPersonList());
    }

    /**
     * Calls {@code BrowserPanelHandle}, {@code PersonListPanelHandle} and {@code
    ...
    /**
     * Asserts that the previously selected card is now deselected and the browser's url remains
     * displaying the details of the previously selected task.
     *
    ...
    protected void assertSelectedCardChanged(Index expectedSelectedCardIndex) {
        ...
        try {
            expectedUrl = new URL(
                BrowserPanel.SEARCH_PAGE_URL + selectedCardName.replaceAll(" ", "%20"));
