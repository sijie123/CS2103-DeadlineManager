...
public class TestApp extends MainApp {
    ...
    protected Supplier<ReadOnlyTaskCollection> initialDataSupplier = () -> null;
    protected Path saveFileLocation = SAVE_LOCATION_FOR_TESTING;

    public TestApp() {
    }

    public TestApp(Supplier<ReadOnlyTaskCollection> initialDataSupplier, Path saveFileLocation) {
        super();
        ...
        if (initialDataSupplier.get() != null) {
            createDataFileWithData(new XmlSerializableTaskCollection(this.initialDataSupplier.get()),
    ...
    public TaskCollection readStorageAddressBook() {
        try {
            ...
            throw new AssertionError("Data is not in the TaskCollection format.", dce);
    ...
    public Path getStorageSaveLocation() {
        return storage.getTaskCollectionFilePath();
    }
    ...
    public Model getModel() {
        Model copy = new ModelManager((model.getTaskCollection()), new UserPrefs());
