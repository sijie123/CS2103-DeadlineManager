...
public class EditCommandParserTest {
    ...
    public void parse_invalidValue_failure() {
        ...
        // invalid phone and invalid priority followed by valid email
        assertParseFailure(parser, "1" + INVALID_PHONE_DESC + EMAIL_DESC_AMY,
            Phone.MESSAGE_PHONE_CONSTRAINTS);

        // invalid priority and invalid priority followed by valid email
        assertParseFailure(parser, "1" + INVALID_PRIORITY_DESC + EMAIL_DESC_AMY,
        ...
        assertParseFailure(parser,
            "1" + INVALID_NAME_DESC + INVALID_EMAIL_DESC + VALID_ADDRESS_AMY + VALID_PHONE_AMY + VALID_PRIORITY_AMY,
    ...
    public void parse_allFieldsSpecified_success() {
        ...
        String userInput = targetIndex.getOneBased() + PHONE_DESC_BOB + PRIORITY_DESC_BOB + TAG_DESC_HUSBAND
    ...
    public void parse_someFieldsSpecified_success() {
        ...
        String userInput = targetIndex.getOneBased() + PHONE_DESC_BOB + PRIORITY_DESC_BOB + EMAIL_DESC_AMY;
    ...
    public void parse_multipleRepeatedFields_acceptsLast() {
        Index targetIndex = INDEX_FIRST_PERSON;
        String userInput =
            targetIndex.getOneBased() + PHONE_DESC_AMY + PRIORITY_DESC_AMY + ADDRESS_DESC_AMY + EMAIL_DESC_AMY
                + TAG_DESC_FRIEND + PHONE_DESC_AMY + PRIORITY_DESC_AMY + ADDRESS_DESC_AMY + EMAIL_DESC_AMY
                + TAG_DESC_FRIEND
                + PHONE_DESC_BOB + PRIORITY_DESC_BOB + ADDRESS_DESC_BOB + EMAIL_DESC_BOB + TAG_DESC_HUSBAND;
