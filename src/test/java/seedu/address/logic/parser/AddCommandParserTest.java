...
public class AddCommandParserTest {
    ...
    public void parse_allFieldsPresent_success() {
        ...
        assertParseSuccess(parser,
            PREAMBLE_WHITESPACE + NAME_DESC_BOB + PHONE_DESC_BOB + PRIORITY_DESC_BOB
                + DEADLINE_DESC_BOB + EMAIL_DESC_BOB
        ...
        assertParseSuccess(parser, NAME_DESC_AMY + NAME_DESC_BOB + PHONE_DESC_BOB
            + PRIORITY_DESC_BOB + DEADLINE_DESC_BOB
            + EMAIL_DESC_BOB + ADDRESS_DESC_BOB + TAG_DESC_FRIEND, new AddCommand(expectedTask));

        // multiple phones - last phone accepted
        assertParseSuccess(parser, NAME_DESC_BOB + PHONE_DESC_AMY + PRIORITY_DESC_BOB
            + DEADLINE_DESC_BOB + PHONE_DESC_BOB
            + EMAIL_DESC_BOB + ADDRESS_DESC_BOB + TAG_DESC_FRIEND, new AddCommand(expectedTask));

        // multiple priorities - last priority accepted
        assertParseSuccess(parser, NAME_DESC_BOB + PHONE_DESC_BOB + PRIORITY_DESC_AMY
            + PRIORITY_DESC_BOB + DEADLINE_DESC_BOB
            + EMAIL_DESC_BOB + ADDRESS_DESC_BOB + TAG_DESC_FRIEND, new AddCommand(expectedTask));

        // multiple deadlines - last deadline accepted
        assertParseSuccess(parser, NAME_DESC_BOB + PHONE_DESC_BOB + PRIORITY_DESC_BOB
            + DEADLINE_DESC_AMY + DEADLINE_DESC_BOB
            + EMAIL_DESC_BOB + ADDRESS_DESC_BOB + TAG_DESC_FRIEND, new AddCommand(expectedTask));

        // multiple emails - last email accepted
        assertParseSuccess(parser, NAME_DESC_BOB + PHONE_DESC_BOB + PRIORITY_DESC_BOB
            + DEADLINE_DESC_BOB + EMAIL_DESC_AMY
            + EMAIL_DESC_BOB + ADDRESS_DESC_BOB + TAG_DESC_FRIEND, new AddCommand(expectedTask));

        // multiple addresses - last address accepted
        assertParseSuccess(parser,
            NAME_DESC_BOB + PHONE_DESC_BOB + PRIORITY_DESC_BOB + EMAIL_DESC_BOB
                + DEADLINE_DESC_BOB + ADDRESS_DESC_AMY
                + ADDRESS_DESC_BOB + TAG_DESC_FRIEND, new AddCommand(expectedTask));
        ...
        Task expectedTaskMultipleTags = new PersonBuilder(BOB)
            ...
            .build();
        assertParseSuccess(parser,
            NAME_DESC_BOB + PHONE_DESC_BOB + PRIORITY_DESC_BOB + DEADLINE_DESC_BOB
    ...
    public void parse_compulsoryFieldMissing_failure() {
        ...
        assertParseFailure(parser,
            VALID_NAME_BOB + PHONE_DESC_BOB + PRIORITY_DESC_BOB + DEADLINE_DESC_BOB
                + EMAIL_DESC_BOB + ADDRESS_DESC_BOB,
            expectedMessage);
        ...
        assertParseFailure(parser,
            NAME_DESC_BOB + PHONE_DESC_BOB + PRIORITY_DESC_BOB + VALID_DEADLINE_BOB
                + EMAIL_DESC_BOB + ADDRESS_DESC_BOB,
            expectedMessage);
        ...
        assertParseFailure(parser,
            VALID_NAME_BOB + VALID_PHONE_BOB + VALID_PRIORITY_BOB + VALID_DEADLINE_BOB
    ...
    public void parse_invalidValue_failure() {
        // invalid name
        assertParseFailure(parser,
            INVALID_NAME_DESC + PHONE_DESC_BOB + PRIORITY_DESC_BOB + DEADLINE_DESC_BOB
                + EMAIL_DESC_BOB + ADDRESS_DESC_BOB
                + TAG_DESC_HUSBAND + TAG_DESC_FRIEND, Name.MESSAGE_NAME_CONSTRAINTS);

        // invalid phone
        assertParseFailure(parser,
            NAME_DESC_BOB + INVALID_PHONE_DESC + PRIORITY_DESC_BOB + DEADLINE_DESC_BOB
                + EMAIL_DESC_BOB + ADDRESS_DESC_BOB
                + TAG_DESC_HUSBAND + TAG_DESC_FRIEND, Phone.MESSAGE_PHONE_CONSTRAINTS);

        // invalid priority
        assertParseFailure(parser,
            NAME_DESC_BOB + PHONE_DESC_BOB + INVALID_PRIORITY_DESC + DEADLINE_DESC_BOB
                + EMAIL_DESC_BOB + ADDRESS_DESC_BOB
                + TAG_DESC_HUSBAND + TAG_DESC_FRIEND, Priority.MESSAGE_PRIORITY_CONSTRAINTS);

        // invalid deadline
        assertParseFailure(parser,
            NAME_DESC_BOB + PHONE_DESC_BOB + PRIORITY_DESC_BOB + INVALID_DEADLINE_DESC
                + EMAIL_DESC_BOB + ADDRESS_DESC_BOB
        ...
        // non-empty preamble
        assertParseFailure(parser,
            PREAMBLE_NON_EMPTY + NAME_DESC_BOB + PHONE_DESC_BOB + PRIORITY_DESC_BOB
                + DEADLINE_DESC_BOB + EMAIL_DESC_BOB
