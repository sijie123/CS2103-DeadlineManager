 ...
 * can be obtained from this class<br> These loggers have been configured to output messages to the
 * console and a {@code .log} file by default, at the {@code INFO} level. A new {@code .log} file
 * with a new numbering will be created after the log file reaches 5MB big, up to a maximum of 5
 * files.<br>
 */
public class LogsCenter {
    ...
    private static final String LOG_FILE = "deadlinemanager.log";
     ...
     * *AFTER* this initialization will have their logging level changed<br> Logging levels for
     * existing loggers will only be updated if the logger with the same name is requested again
     * from the LogsCenter.
     */
    ...
    /**
     * Adds the {@code consoleHandler} to the {@code logger}. <br> Creates the {@code
     * consoleHandler} if it is null.
     */
    ...
    /**
     * Adds the {@code fileHandler} to the {@code logger}. <br> Creates {@code fileHandler} if it is
     * null.
     */
