...
* **`add`**`n/John Doe p/98765432 e/johnd@example.com a/John street, block 123, #01-01` : adds a contact named `John Doe` to the deadline manager.
...
Format: `add n/NAME p/PHONE_NUMBER P/PRIORITY e/EMAIL a/ADDRESS [t/TAG]...`
...
* `add n/John Doe p/98765432 P/1 e/johnd@example.com a/John street, block 123, #01-01`
* `add n/Betsy Crowe t/friend e/betsycrowe@example.com a/Newgate Prison p/1234567 P/2 t/criminal`
...
* n stands for name and d stands for due date
...
Clears all entries from the deadline manager. +
Format: `clear`
