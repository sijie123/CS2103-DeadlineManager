...
.Screenshot of simplified filter syntax
...
`FILTER_EXPRESSION` is a string in any of the following possible formats:
...
image::userguide/filter_set_example.png[width="800"]
...
.Screenshots displaying errors in the filter expression
image::userguide/filterdemo_error_combined.png[FilterDemo_Combined, width="800"]
