...
[NOTE]
Due to limited space, detailed technical implementation of inter-component communication is omitted, and an overview is presented below in <<Sequence Flow, Sequence Flow>> instead. You may wish to refer to the https://cs2103-ay1819s1-w17-4.github.io/main/DeveloperGuide.html#inter-component-communication[Developer Guide] for details.
